$(function() {
	...
	frappe.call({
		...
		callback: function(r) {
			...
			Morris.Area({
				element: 'morris-area-chart-current-year',
				data: [{
					period: year + '-01',
	...
	// prior year
	frappe.call({
		method: 'libradash.www.libradash.get_prior_datas',
		args: {},
		callback: function(r) {
			var sinv_total_jan = 0;
			var sinv_total_feb = 0;
			...
			Morris.Area({
				element: 'morris-area-chart-prior-year',
				data: [{
					period: year + '-01',
					sales_orders: parseInt(dn_total_jan),
					delivery_notes: parseInt(so_total_jan),
	...
	// comparative
	frappe.call({
		method: 'libradash.www.libradash.get_comparative_datas',
		args: {},
		callback: function(r) {
			var sinv_prior = 0;
			var sinv_current = 0;
			...
			Morris.Bar({
				element: 'morris-bar-chart-prior-year-comparative',
				data: [{
					y: 'Sales Order',
					prior: so_prior,
					current: so_current
